...
/// FedsLocalSqflite is a class that implements the FedsLocal interface
/// using the sqflite package for SQLite database operations.
...
class FedsLocalSqflite implements FedsLocal {
  ...
  Future<Database?> _initDatabase() async {
    ...
    // If androidVersionPath is provided, use it to set the deviceDbPath
    // Uncomment the following lines if you want to use android 6.0
    // if (androidVersionPath != null) {
    //   deviceDbPath = '/data/data/<app.package.here>/files';
    // }
